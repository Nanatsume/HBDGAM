...
import Scene1Park from './components/Scene1Park';
...
function App() {
  ...
  return (
    <div className="w-screen h-screen bg-black overflow-hidden relative font-sans">
      ...
      {scene === 1 && <Scene1Park onComplete={nextScene} />}
      {scene === 2 && <Scene2Book onComplete={nextScene} />}
      {scene === 3 && <Scene3Heart onComplete={nextScene} />}
      {scene === 4 && <Scene4Proposal />}
    </div>
  );
}
